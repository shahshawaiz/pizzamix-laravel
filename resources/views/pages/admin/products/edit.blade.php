  ...
  <div class="add-deal">
    ...
    <div class="deal-add-part2 add-product" style="width: 58%">
        ...
        <fieldset class="form-group">
            ...
            {{ Form::text('name' , $product->name, ['class'=>'form-control', 'required'=>'true', 'placeholder'=>'Product Name']) }} 
            <small class="text-muted"></small>         
        </fieldset>

        <fieldset class="form-group">
            <label>Description:</label>          
            {{ Form::text('description' , $product->description, ['class'=>'form-control', 'required'=>'true', 'placeholder'=>'Description']) }}
            <small class="text-muted"></small>         
        </fieldset>

        <fieldset class="form-group">
            <label>Category:</label>          
            {{ Form::select('category_id', $categories, $product->category_id, ['class'=>'form-control' , 'required'=>'true', 'style'=>'width:100%', 'placeholder'=>'Please select a product' ]) }}
            <small class="text-muted"></small>         
        </fieldset>
