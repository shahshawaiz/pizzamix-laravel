    ...
    $category,                 
      ...
      <div class="deal-add-part1" style="width: 100%">
        ...
        <div class="deal-add-part2 add-product" style="width: 100%">
            ...
            <fieldset class="form-group">       
                {{ Form::text('name' , $category->name, ['class'=>'form-control', 'placeholder'=>'Product Name', 'required'=>'true']) }} 
                <small class="text-muted"></small>         
            </fieldset>

            <fieldset class="form-group">       
                {{ Form::text('description' , $category->description, ['class'=>'form-control', 'placeholder'=>'Description', 'required'=>'true']) }}
                <small class="text-muted"></small>         
            </fieldset>

            <fieldset class="form-group">     
                {{ Form::select('cuisine_id', $cuisines, $category->cuisine_id, ['class'=>'form-control', 'placeholder'=>'Please select a cuisine', 'style'=>'width:100%']) }}  
                <small class="text-muted"></small>         
            </fieldset>
