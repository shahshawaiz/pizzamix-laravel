            ...
            <div class="content">
                ...
                <table class="table table-striped tablesorter">
                        ...
                        @if(count($orders->disapproved->get()) != 0)

                            @foreach($orders->disapproved->get() as $req)                
                                <tr>
                                    ...
                                    <td width="20%">
                                        <button type="button" value="{{$req->id}}"class="btnUpdateStatus btn btn-primary btn-xs">Hide
                                        </button>
                                    </td>                          
                                </tr>                                      
                            @endforeach                 
